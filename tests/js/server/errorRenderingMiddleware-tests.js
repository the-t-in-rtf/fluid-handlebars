...
fluid.registerNamespace("gpii.tests.handlebars.errorRenderingMiddleware.errorGeneratingRouter");
gpii.tests.handlebars.errorRenderingMiddleware.errorGeneratingRouter.route = function (next) {
    next({ isError: true, message: "*sound of drums*"});
};

fluid.defaults("gpii.tests.handlebars.errorRenderingMiddleware.errorGeneratingRouter", {
    gradeNames: ["gpii.express.router"],
    path:       "/untemperedSchism",
    namespace:  "errorGeneratingRouter",
    invokers: {
        route: {
            funcName: "gpii.tests.handlebars.errorRenderingMiddleware.errorGeneratingRouter.route",
            args:     ["{arguments}.2"] // req, res, next
        }
    }
});

fluid.defaults("gpii.tests.handlebars.errorRenderingMiddleware.request", {
    gradeNames: ["gpii.tests.express.request"],
    endpoint:   "untemperedSchism"
});

fluid.defaults("gpii.templates.tests.errorRenderingMiddleware.caseHolder", {
    ...
    components: {
        htmlRequest: {
            type: "gpii.tests.handlebars.errorRenderingMiddleware.request",
            options: {
                headers: {
                    accept: "text/html"
                }
...
fluid.defaults("gpii.templates.tests.errorRenderingMiddleware.environment", {
    ...
    components: {
        express: {
            ...
            options: {
                ...
                components: {
                    ...
                    errorGeneratingRouter: {
                        type: "gpii.tests.handlebars.errorRenderingMiddleware.errorGeneratingRouter",
                        options: {
                    ...
                    htmlErrorHandler: {
                        ...
                        options: {
                            ...
                            priority: "after:errorGeneratingRouter"
                        }
                    },
                    defaultErrorHandler: {
        ...
        caseHolder: {
            type: "gpii.templates.tests.errorRenderingMiddleware.caseHolder"
        }
    }
});

gpii.templates.tests.errorRenderingMiddleware.environment();