...
fluid.registerNamespace("fluid.test.handlebars.server");
fluid.test.handlebars.server.isSaneResponse = function (error, response, body) {
...
fluid.test.handlebars.server.bodyMatches = function (message, body, pattern, shouldNotMatch) {
